import { Container, Flex, FlexProps, Center } from "@chakra-ui/react";
      ...
      <Container flex="1">
        <Center>
          ...
          <p className={styles.description}>
            Stay tuned for the exciting launch of Pepechain, the
            state-of-the-art L2 rollup chain for memecoin traders, gaming
            enthusiasts, and DeFi users!
          </p>
          <br />
          <br />
          <iframe
